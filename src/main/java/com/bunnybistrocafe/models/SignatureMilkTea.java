...
/**
 * Represents a signature milk tea drink with a unique name.
 */
public class SignatureMilkTea extends MilkTea {
    private final String signatureName;

    /**
     * Constructor for a signature milk tea with default drink size, type, and other inherited attributes.
     *
     * @param toppings list of {@link Topping} for the milk tea
     * @param teaType the type of tea used
     * @param flavors list of {@link TeaFlavor} objects
     * @param signatureName the unique name of this signature milk tea
     */
    ...
    /**
     * Full constructor for a signature milk tea with all customizable drink attributes.
     *
    ...
    /**
     * Returns the unique signature name of this milk tea.
     *
    ...
    /**
     * Returns the display name of this milk tea.
